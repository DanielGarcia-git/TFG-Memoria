...
\begin{figure}[H]
    \begin{center}
      \includegraphics[width=15cm]{figuras/Capitulo_02/Cap_02_IDAPro_binaryseacrh1.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
      \includegraphics[width=15cm]{figuras/Capitulo_02/Cap_02_IDAPro_binaryseacrh2.png}
    \end{center}
