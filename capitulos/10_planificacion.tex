...
% TODO:daniel: Revisar la planificación
...
A continuación, como se menciona en el capítulo \ref{cap:introducion}, donde definimos
los riegos que supone un proyecto de este tipo, detallaremos los planes alternativos
para solucionar los riegos a los cuales nos enfrentamos. Así mismo, se detallará la
probabilidad y el impacto que un riesgo pueda tener sobre nuestro proyecto.
...
como se detalla en el sección \ref{sec:descripcion_tareas}. Estas son las etapas que se han definido:
...
\footnote{Google Meet es un servicio de videotelefonía desarrollado por Google \cite{MeetSite}}.
