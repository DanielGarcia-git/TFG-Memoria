...
\begin{figure}
 \ \ \ \ \includegraphics[width=0.25\linewidth]{figuras/Licencia/by-nc-sa.png}
 \label{fig:cc} 
 \end{figure}
...
\begin{flushright}
		\vspace{7.0 cm}
		\emph{Documento de} \textbf{Daniel García Estévez}. % TODO: pon aquí tu nombre cuando hagas el documento
\end{flushright}
