...
Existen diferentes estudios y articulos que exploran la via de utilizar redes neuronales,
de diferentes tipos y arquitecturas, para poder aplicar ingeniería inversa sobre un programa
y obtener un código en C, concretamente estos estudios persigen obtener un descompilador utilizando
