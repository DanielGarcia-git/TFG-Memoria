...
\begin{table}[H]
    ...
    \rowcolor[HTML]{8EA9D8} 
    Módulo & Submódulo      & Clase           & Función & Descripción \\ \hline
    utils  & utils.abstract & -               &         &             \\ \hline
    utils  & utils.abstract & Task            &         &             \\ \hline
    utils  & utils.enum     & -               &         &             \\ \hline
    utils  & utils.enum     & Arguments       &         &             \\ \hline
    utils  & utils.enum     & CompilerOptions &         &             \\ \hline
    utils  & utils.enum     & Compilers       &         &             \\ \hline
    utils  & utils.enum     & OperatingSystem &         &             \\ \hline
    utils  & utils.enum     & Paths           &         &             \\ \hline
    utils  & utils.enum     & RepositoryType  &         &             \\ \hline
    utils  & utils.file     & -               &         &             \\ \hline
    utils  & utils.file     & File            &         &             \\ \hline
    utils  & utils.file     & CodeFile        &         &             \\ \hline
    utils  & utils.file     & ObjdumpFile     &         &             \\ \hline
    \end{tabular}%
    }
