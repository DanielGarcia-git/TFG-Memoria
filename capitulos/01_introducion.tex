...
\begin{itemize}
    ...
    \item \textbf{Capítulo 3: Estado del arte de la ingeniería inversa.} En este capítulo
        ...
        que existen.
    \item \textbf{Capítulo 4: Diseño e implementación del sistema de scripts.} En este
    ...
    \item \textbf{Capítulo 5: Estrategia de entrenamiento.} En este capítulo se detallará
        la estrategia de entrenamiento que se ha utilizado para poder entrenar el modelo.
    \item \textbf{Capítulo 6: Resultados.} En este capítulo se detallarán los resultados
        obtenidos durante el entrenamiento del modelo.
    \item \textbf{Capítulo 7: Planificación.} En este capítulo se detallará la planificación
    ...
    \item \textbf{Capítulo 8: Presupuesto.} En este capítulo se detallará el presupuesto
        del proyecto, así como los recursos necesarios para poder llevar a cabo el proyecto.
    \item \textbf{Capítulo 9: Sostenibilidad.} En este capítulo se detallará el impacto
